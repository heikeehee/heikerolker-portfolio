...
2. Download the relevant Tanzania NPS wave(s), specifically the agricultural production module and the household consumption module.
...
This project also uses processed outputs from `01-smallholder-material-flow`. Ensure that project has been run first and its outputs are available before running scripts in this project.
