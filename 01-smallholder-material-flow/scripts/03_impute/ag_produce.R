...
# =============================================================================
# SECTION 1: UNIT CONVERSION TABLES
# ASSUMPTION AP1: litre-to-kg conversion uses product-specific factors
# =============================================================================
...
saveRDS(
  inputlong,
  here::here("data", "processed", "01", "impute", "mass_agprod_long.rds"),
  compress = TRUE
)
...
# ASSUMPTION AP2: household-specific input split for unresolved case
...
# ASSUMPTION AP3: final fallback uses full input when allocation unresolved
...
saveRDS(
  ap_convert,
  here::here("data", "processed", "01", "impute", "ag_produce_imputed.rds"),
  compress = TRUE
)
...
readr::write_csv(
  as.data.frame(flag_summary(ap_convert)),
  here::here("data", "processed", "01", "impute", "ag_produce_flag_summary.csv")
)

readr::write_csv(
  as.data.frame(flag_summary(as.data.table(inputs_final))),
