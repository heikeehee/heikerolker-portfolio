...
# save data to Chapter 5
saveRDS(p, file = "~/Library/CloudStorage/OneDrive-UniversityofBristol/03c_PCA/2_data/files/plots_longlist.RDS", compress = TRUE)
```
...
saveRDS(crops_prelost, "2_data/processed/crops_prelost.RDS", compress = T)
```
