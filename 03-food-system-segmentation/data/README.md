# Data — 03 Household Food System Segmentation
...
This project uses processed outputs from both `01-smallholder-material-flow` and `02-survey-harmonisation`. Ensure both of those projects have been run first and their outputs are available before running scripts in this project.
